...
`MultiServerMCPClient` spawns bexio-mcp locally over stdio. This works today straight from GitHub (once the package is on npm, `npx -y bexio-mcp` will work too):
